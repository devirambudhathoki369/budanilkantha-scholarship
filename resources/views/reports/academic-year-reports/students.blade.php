    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">{{ $schoolYear->school->school_name }} - विद्यार्थी सूची</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('reports.academic-year-reports.index') }}">शैक्षिक सत्रअनुसार प्रतिवेदन</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <!-- Filter Form -->
                            <form method="GET" action="{{ route('reports.academic-year-reports.students', $schoolYear->id) }}" class="row g-3">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <a href="{{ route('reports.academic-year-reports.students', $schoolYear->id) }}" class="btn btn-secondary"><i class="bx bx-reset"></i> रिसेट</a>
                                </div>
                            </form>
                        </div>
                    </div>
